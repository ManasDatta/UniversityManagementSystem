    ...
    <div class="details_area2">
        <asp:MultiView ID="MultiView1" runat="server" ActiveViewIndex="0" >
         <asp:View ID="View1" runat="server">
             <p>+ Add New Faculty</p>
        <asp:Label ID="Label1" runat="server" Text="Faculty Id:"></asp:Label> <br />
        <asp:TextBox ID="TextBoxId" runat="server" BorderWidth="1px" Height="25px" Width="250px"></asp:TextBox>
                ...
                <asp:RegularExpressionValidator ID="RegularExpressionValidator1" runat="server" ErrorMessage="*Invalid Format (ex: 1234-567-1)" ForeColor="Red" ControlToValidate="TextBoxId" Display="Dynamic" ValidationExpression="[0-9]{4}-[0-9]{3}-[1-2]"></asp:RegularExpressionValidator><br /><br />
        ...
        <asp:TextBox ID="TextBoxName" runat="server" BorderWidth="1px" Height="25px" Width="250px"></asp:TextBox>
             ...
             <asp:RegularExpressionValidator ID="RegularExpressionValidator4" runat="server" ErrorMessage="*Only letters, white space, dots and hiphens are allowed" ForeColor="Red" ValidationExpression="^[a-zA-Z .-]*$" ControlToValidate="TextBoxName" Display="Dynamic"></asp:RegularExpressionValidator><br /><br />
        ...
        <asp:TextBox ID="TextBoxNationality" runat="server" BorderWidth="1px" Height="25px" Width="250px"></asp:TextBox>
            ...
            <asp:RegularExpressionValidator ID="RegularExpressionValidator5" runat="server" ErrorMessage="*Only letters and white space are allowed" ForeColor="Red" ValidationExpression="^[a-zA-Z ]*$" ControlToValidate="TextBoxNationality" Display="Dynamic"></asp:RegularExpressionValidator><br /><br />
        ...
        <asp:TextBox ID="TextBoxReligion" runat="server" BorderWidth="1px" Height="25px" Width="250px"></asp:TextBox>
            ...
            <asp:RegularExpressionValidator ID="RegularExpressionValidator6" runat="server" ErrorMessage="*Only letters and white space are allowed" ForeColor="Red" ValidationExpression="^[a-zA-Z ]*$" ControlToValidate="TextBoxReligion" Display="Dynamic"></asp:RegularExpressionValidator><br /><br />
        ...
        <asp:DropDownList ID="DropDownListMaritalStatus" runat="server" Height="30px" Width="250px">
            ...
            <asp:ListItem>Divorced</asp:ListItem>
                ...
                <br />
            <br />
        <asp:Label ID="Label15" runat="server" Text="School:"></asp:Label> <br />
        ...
        <asp:RequiredFieldValidator ID="RequiredFieldValidator8" runat="server" ErrorMessage="*Required Field" ForeColor="Red" ControlToValidate="TextBoxSchool" Display="Dynamic"></asp:RequiredFieldValidator>
            <asp:RegularExpressionValidator ID="RegularExpressionValidator7" runat="server" ErrorMessage="*Only letters, white space, dots and hiphens are allowed" ForeColor="Red" ValidationExpression="^[a-zA-Z .-]*$" ControlToValidate="TextBoxSchool" Display="Dynamic"></asp:RegularExpressionValidator><br /><br />
        ...
        <asp:Label ID="Label16" runat="server" Text="College:"></asp:Label> <br />
        ...
        <asp:RequiredFieldValidator ID="RequiredFieldValidator9" runat="server" ErrorMessage="*Required Field" ForeColor="Red" ControlToValidate="TextBoxCollege" Display="Dynamic"></asp:RequiredFieldValidator>
            <asp:RegularExpressionValidator ID="RegularExpressionValidator8" runat="server" ErrorMessage="*Only letters, white space, dots and hiphens are allowed" ForeColor="Red" ValidationExpression="^[a-zA-Z .-]*$" ControlToValidate="TextBoxCollege" Display="Dynamic"></asp:RegularExpressionValidator><br /><br />
        ...
        <asp:Label ID="Label17" runat="server" Text="Undergraduate:"></asp:Label> <br />
        ...
        <asp:RequiredFieldValidator ID="RequiredFieldValidator10" runat="server" ErrorMessage="*Required Field" ForeColor="Red" ControlToValidate="TextBoxUndergraduate" Display="Dynamic"></asp:RequiredFieldValidator>
            <asp:RegularExpressionValidator ID="RegularExpressionValidator9" runat="server" ErrorMessage="*Only letters, white space, dots and hiphens are allowed" ForeColor="Red" ValidationExpression="^[a-zA-Z .-]*$" ControlToValidate="TextBoxUndergraduate" Display="Dynamic"></asp:RegularExpressionValidator><br /><br />
            <asp:Label ID="Label22" runat="server" Text="Undergraduate Passing Year:"></asp:Label> <br />
        <uc2:yearControl runat="server" id="yearControl3" /><br /><br />

        <asp:Label ID="Label18" runat="server" Text="Postgraduate:"></asp:Label> <br />
        ...
        <asp:RequiredFieldValidator ID="RequiredFieldValidator11" runat="server" ErrorMessage="*Required Field" ForeColor="Red" ControlToValidate="TextBoxPostgraduate" Display="Dynamic"></asp:RequiredFieldValidator>
            <asp:RegularExpressionValidator ID="RegularExpressionValidator10" runat="server" ErrorMessage="*Only letters, white space, dots and hiphens are allowed" ForeColor="Red" ValidationExpression="^[a-zA-Z .-]*$" ControlToValidate="TextBoxPostgraduate" Display="Dynamic"></asp:RegularExpressionValidator><br /><br />
        <asp:Label ID="Label23" runat="server" Text="Postgraduate Passing Year:"></asp:Label> <br />
        <uc2:yearControl runat="server" id="yearControl4" /><br /><br />

        <asp:Label ID="Label19" runat="server" Text="PHD: (Optional)"></asp:Label> <br />
        <asp:TextBox ID="TextBoxPHD" runat="server" BorderWidth="1px" Height="25px" Width="250px"></asp:TextBox>
            <asp:RegularExpressionValidator ID="RegularExpressionValidator11" runat="server" ErrorMessage="*Only letters, white space, dots and hiphens are allowed" ForeColor="Red" ValidationExpression="^[a-zA-Z .-]*$" ControlToValidate="TextBoxPHD" Display="Dynamic"></asp:RegularExpressionValidator><br /><br />
        <asp:Label ID="Label24" runat="server" Text="PHD Passing Year: (Optional)"></asp:Label> <br />
        <asp:TextBox ID="TextBoxPHDPassingYear" runat="server" BorderWidth="1px" Height="25px" Width="250px"></asp:TextBox><br /><br />
            ...
            <asp:Label ID="Label12" runat="server" Text="Joining Date:"></asp:Label> <br />
         <uc1:calendarControl runat="server" id="calendarControl1" /> <br /><br />
        
        <asp:Label ID="Label13" runat="server" Text="Department:"></asp:Label> <br />
        <asp:DropDownList ID="DropDownListDepartment" runat="server" Height="30px" Width="250px">
            <asp:ListItem>CSE</asp:ListItem>
            <asp:ListItem>EEE</asp:ListItem>
                </asp:DropDownList><br /><br />
        <asp:Label ID="Label14" runat="server" Text="Position:"></asp:Label> <br />
        ...
        <asp:Label ID="Label26" runat="server" Text="Confirm Password:"></asp:Label> <br />
