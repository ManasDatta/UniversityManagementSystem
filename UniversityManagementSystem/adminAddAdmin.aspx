    ...
    <div class="details_area2">
        <asp:MultiView ID="MultiView1" runat="server" ActiveViewIndex="0" >
            <asp:View ID="View1" runat="server">
                <p>+ Add New Admin</p>
        <asp:Label ID="Label1" runat="server" Text="Admin Id:"></asp:Label> <br />
        <asp:TextBox ID="TextBoxId" runat="server" BorderWidth="1px" Height="25px" Width="250px"></asp:TextBox>
                ...
                <asp:RegularExpressionValidator ID="RegularExpressionValidator1" runat="server" ErrorMessage="*Invalid Format (ex: 123-4567-1)" ForeColor="Red" ControlToValidate="TextBoxId" Display="Dynamic" ValidationExpression="[0-9]{3}-[0-9]{4}-[1-2]"></asp:RegularExpressionValidator><br /><br />
        ...
        <asp:TextBox ID="TextBoxPassword" runat="server" BorderWidth="1px" Height="25px" Width="250px" CausesValidation="True"></asp:TextBox>
             <asp:RequiredFieldValidator ID="RequiredFieldValidator8" runat="server" ErrorMessage="*Required Field" ForeColor="Red" Display="Dynamic" ControlToValidate="TextBoxPassword"></asp:RequiredFieldValidator><br /><br />
